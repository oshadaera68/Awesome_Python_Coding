...
class GIFMaker(tk.Tk):
    def __init__(self):
        ...
        self.canvas = tk.Canvas(self, width=640, height=480, background='#eeeee0')
        ...
        self.progress_bar = ttk.Progressbar(self, orient=tk.HORIZONTAL, length=100, mode='indeterminate')
    ...
    def animate_preview(self):
        ...
        self.preiview_frame_index = (self.preview_frame_index + 1) % len(self.frames)
    ...
    def create_gif(self, fps, scale):
        ...
        self.after(0, self.progress_bar.step())
